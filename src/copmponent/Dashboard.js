...
function Dashboard() {
    ...
    const addDomain = () => {
        ...
        if (editIndex !== null) {
            ...
            updatedDomains[editIndex] = { domain: newDomain, dnsRecord: newDNSRecord, recordType: recordType };
    ...
    return (
        <div className="container">
            ...
            <Modal isOpen={isModalOpen} onRequestClose={closeModal}>
                ...
                <button onClick={addDomain}>{editIndex !== null ? 'Save Changes' : 'Add Domain'}</button>
